...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/css/portrait.css?t=">
...
<!-- 				</form> -->
		...
		<div class="work_style" style="height: 90%;">
			<div class="div_l">
				<div class="div_m">
					<div class="div_s">
						<div class="div_s_t">
							<a href="<%=basePath%>jsp/map/MSMap.jsp">
						...
						<div class="div_s_b">
							<a href="<%=basePath%>jsp/map/MSMap.jsp">地图</a>
						</div>
					</div>
					<div class="div_s">
						<div class="div_s_t">
