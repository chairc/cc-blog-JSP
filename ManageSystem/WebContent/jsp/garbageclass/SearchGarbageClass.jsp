	...
	<div
		...
		<div style="text-align: center; padding-left: 5%; padding-right: 5%;">
			...
			<div style="width: 100%; padding-left: 30%; padding-right: 30%;">
				<form action="GarbageClassServlet" method="post">
					<div style="width: 100%;">
						<div style="float: left;width: 100%;">							
							<input type="text" style="width: 100%;" class="form-control"
								name="searchgarbagename" placeholder="添加需要查询垃圾名称"  maxlength="30">
						</div>
					</div>
					...
					<div
						...
						<input class="btn btn-primary" type="button"
							onclick="location.href='<%=basePath%>ChairC_Index.jsp'" style="width: 90%" value="返回">
					</div>
				</form>
			</div>
		</div>
