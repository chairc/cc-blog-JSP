		...
		<div class="swiper-wrapper"
			...
			<div class="swiper-slide menu swiper-slide-prev">
				<div class="menu" style="">
					...
					<a href="jsp/backstage/IframeIndex.jsp">主界面</a><br> 
					<a href="jsp/backstage/Success_layui.jsp">layui界面</a><br>
					<a href="jsp/backstage/ShowAll_new.jsp">查看所有用户</a><br>
					<a href="Editall">编辑所有用户</a><br>
					<a href="Editinfo">修改信息</a><br>
					<a href="SearchLoginLogServlet">登陆日志</a><br>
					<a href="MessageServlet">留言板</a><br>
					<a href="jsp/others/Donation.jsp">前去赞助</a><br>
					<a href="jsp/others/Aboutus.jsp">关于我们</a><br>
				...
				<div>
					...
					<div class="menu-artical swiper-no-swiping">	
						<ul class="menu-artical-ul">
							...
							<li id="liclick" class="menu-artical-li" style="width: 60px;">
								<a href="jsp/backstage/IframeIndex.jsp" target="aaa">
									<div>主页</div>
								</a>
							</li>
						</ul>					
