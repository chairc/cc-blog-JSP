				...
				<div style="width: 100%; height: 100%;">
					...
					<div class="border_thin"
						...
						<div style="padding-top: 30px;">
							...
							<div>
								<a href="<%=basePath%>jsp/basic/Register_new.jsp">返回注册界面</a>
							</div>
							<div>
								<a href="<%=basePath%>ChairC_Index.jsp">返回主界面</a>
							</div>
							<div>
								<a href="<%=basePath%>jsp/others/Donation.jsp" target="_blank">赞助一波？</a>
							</div>
						</div>
					</div>
				</div>
